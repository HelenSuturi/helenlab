package com.example.helen.lab4;
...
import com.example.helen.lab4.utils.GalleryStructure;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int [] casas = {R.drawable.img1, R.drawable.img2, R.drawable.img3, R.drawable.img4, R.drawable.img5};
        for(int i=0;i<5;i++){
...
+         */
        public static PlaceholderFragment newInstance(GalleryStructure data) {
            ...
            args.putString("Label", data.getDes());
